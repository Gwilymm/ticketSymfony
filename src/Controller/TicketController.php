...
class TicketController extends AbstractController
{
    ...
    public function __construct(TicketRepository $ticketRepository, Registry $registry, TranslatorInterface $translator, MailerInterface $mailer, LoggerInterface $logger)
    {
    ...
    public function ticket(Request $request, Ticket $ticket = null)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            if ($request->attributes->get('_route') === 'ticket_creation') {
                ...
                MailerController::sendEmail($this->mailer, "poneyPourDaron@sabot.fr", "ticket ajouté", "a bien été ajouté", $ticket);
            } else {
                $this->addFlash(
                    'info',
                    'Votre ticket a bien été mis à jour'
                );
                MailerController::sendEmail($this->mailer, "poneyPourDaron@sabot.fr", "ticket modifié", "a bien été modifié", $ticket);
            }
